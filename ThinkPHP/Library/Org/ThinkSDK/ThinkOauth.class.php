...
abstract class ThinkOauth{
	...
	public function __construct($token = null){
		...
		$classType = strtoupper(substr($class, 0, strlen($class)-3));

		//TP3.2用命名空间，所以要执行以下逻辑得到Type
		$typeArr = explode('\\',$classType);
...
//    	require_once "sdk/{$name}.class.php";  //没有命名空间时的写法
		$class = "\\Org\\ThinkSDK\\sdk\\".$name;  //3.2引入命名空间后的写法
